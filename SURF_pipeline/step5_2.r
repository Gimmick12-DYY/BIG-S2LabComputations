...
for(ii in 1:L)
{
	...
	str0=paste0('cd ${HCP_DATA}/',sub0[ii],'/T1_out/',sub0[ii],'/MNINonLinear;wb_command -cifti-parcellate Results/',fmriPath,'/',fmriPath,'_Atlas_s0.dtseries.nii ')
	...
	str0=paste0(str0,'COLUMN Results/',fmriPath,'/',fmriPath,'_Atlas_s0.ptseries.nii;')
	str0=paste0(str0,'wb_command -cifti-convert -to-text Results/',fmriPath,'/',fmriPath,'_Atlas_s0.ptseries.nii ')
	str0=paste0(str0,'Results/',fmriPath,'/',fmriPath,'_Atlas_s0.txt;')
	system(str0)
}
##############################
...
for(ii in 1:L)
{
	...
	str0=paste0(str0,'COLUMN Results/',fmriPath,'/',fmriPath,'_Atlas_s0_R.ptseries.nii;')
	str0=paste0(str0,'wb_command -cifti-convert -to-text Results/',fmriPath,'/',fmriPath,'_Atlas_s0_R.ptseries.nii ')
	str0=paste0(str0,'Results/',fmriPath,'/',fmriPath,'_Atlas_s0_R.txt;')
	system(str0)
}
for(ii in 1:L)
{
if(ii%%10==0)print(L-ii)
A1=read.table(paste0('data/',sub0[ii],'/T1_out/',sub0[ii],'/MNINonLinear/Results/',fmriPath,'/',fmriPath,'_Atlas_s0.txt'),head=F)
A2=read.table(paste0('data/',sub0[ii],'/T1_out/',sub0[ii],'/MNINonLinear/Results/',fmriPath,'/',fmriPath,'_Atlas_s0_R.txt'),head=F)
A3=t(rbind(A1,A2))
write.table(A3,file=paste0('data/',sub0[ii],'/T1_out/',sub0[ii],'/MNINonLinear/Results/',fmriPath,'/',fmriPath,'_Atlas_s0_T.txt'),quote=F,row.names=F,col.names=F)
}
