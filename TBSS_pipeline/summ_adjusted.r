Home0='/work/users/d/y/dyy12/WORK_TBSS/TBSS/'
...
mod0=c('MD','MO','S0','L1','L2','L3','FA')
sub0=dir(paste0(Home,'/MD_individ/MD_ENIGMA_ROI_part2'))
sub0=unlist(strsplit(sub0,'_MD_ROIout_avg.csv'))
#sub0=Sys.glob('/pine/scr/t/e/tengfei/TBSS/TBSS/Enigma_ROI_1/avg_*_ROIout.csv')
#sub0=unlist(lapply(strsplit(sub0,'/'),'[',10));sub0=unlist(lapply(strsplit(sub0,'_'),'[',2))
l=length(mod0)
for(i in 1:l)
{
