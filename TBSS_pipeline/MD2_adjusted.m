...
home_dir = '/work/users/d/y/dyy12/WORK_TBSS/';               % PATH to change
...
mkdir(fullfile(parentDirectory,'V2_individ','V2_ENIGMA_ROI_part1')); 
mkdir(fullfile(parentDirectory,'V3_individ','V3_ENIGMA_ROI_part1')); 
...
mkdir(fullfile(parentDirectory,'S0_individ','S0_ENIGMA_ROI_part1')); 
...
mkdir(fullfile(parentDirectory,'V2_individ','V2_ENIGMA_ROI_part2')); 
mkdir(fullfile(parentDirectory,'V3_individ','V3_ENIGMA_ROI_part2')); 
...
mkdir(fullfile(parentDirectory,'S0_individ','S0_ENIGMA_ROI_part2')); 
...
for kk=1:K
    ...
    fprintf(fid,'#SBATCH --time=00:59:59\n');
